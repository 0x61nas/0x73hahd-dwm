...
make:
    ...
    cd {{justfile_directory()}}/source && make -j

package: make
    cd {{justfile_directory()}} && mkdir dist
    cd {{justfile_directory()}} && cp slstatus/slstatus dist
    cd {{justfile_directory()}} && cp source/dwm dist
